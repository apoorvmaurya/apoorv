        ...
        >
          ...
          >
            ...
            <p className="text-muted-foreground">
              I&apos;m always looking for new opportunities to contribute to the tech community, 
              whether it&apos;s through mentoring, speaking at events, or collaborating on open-source projects.
              If you have an opportunity in mind, I&apos;d love to hear about it!
            </p>
            <button 
              onClick={() => {
